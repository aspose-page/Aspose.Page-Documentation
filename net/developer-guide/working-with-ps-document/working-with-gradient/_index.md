...
As gradient is a kind of paint, it is expectedly that in .NET it is implemented as subclass of **System.Drawing.Brush**. Actually, .NET platform has two such brushes:
...
<br>
<br>
In order to *paint* graphics objects with gradient in Aspose.Page for .NET library it is necessary to create **System.Drawing.LinearGradientBrush** or 
...
<br>
In order to *outline* graphics objects with gradient in Aspose.Page for .NET library someone should create **System.Drawing.LinearGradientBrush** or 
...
<br>
<br>
In the example below we demonstrate how to fill a shape and text and outline text with gradient.
<br>
<br>
An algorythm of *painting* graphics objects with gradient in new PS document includes following steps:
...
5. Create an object of **System.Drawing.LinearGradientBrush** or **System.Drawing.PathGradientBrush** in dependence on wishfull form of gradient.
6. Set necessary transformation on this brush.
8. Set gradient brush as current paint in PsDocument
9. Fill graphics path with current paint or fill a text. If we use one of the methods for filling text that accepts **System.Drawing.Brush** as a parameter, previous point can be ignored.
10. Close page.
11. Save document.

If we need *stroking (outlining)* graphics objects with gradient instead of the last 4 points following will be:

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8. Create **System.Drawing.Pen** object with gradient brush.<br>
...
We offer 5 code snippets that demonstrate usage of different gradients
<br>
<br>
...
<p align="center">
	<img src="HorizontalGradient_outPS.png">
</p>
</br></br></br>
...
<p align="center">
	<img src="VerticalGradient_outPS.png">
</p>
</br></br></br> 
...
<p align="center">
	<img src="DiagonaGradient_outPS.png">
</p>
</br></br></br>
...
<p align="center">
	<img src="RadialGradient1_outPS.png">
</p>
</br></br></br>
...
<p align="center">
	<img src="RadialGradient2_outPS.png">
</p>
</br></br></br>
