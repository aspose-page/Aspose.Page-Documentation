---
title: Convert EPS to WMF using Java
type: docs
weight: 20
url: /java/convert/eps-to-wmf/
description: EPS to WMF conversion functionality offered by Aspose.Page API solution for Java is explained and illustrated with the code snippets here.
---
...
Aspose.Page for Java EPS to WMF converter allows to convert Encapsulated PostScript (EPS) file to WMF image on any OS for which Java Virtual Machine exists.
...
<br>Following code snippet shows how to convert EPS to WMF files in Java:
<br>
```Java
...
```
{{% alert color="primary" %}}
See EPS to WMF conversion in [.NET](/page/net/convert/eps-to-wmf/) and [C++](/page/cpp/convert/eps-to-wmf/).
{{% /alert %}}

Let's consider [ImageSaveOptions](https://apireference.aspose.com/page/java/com.aspose.eps.device/imagesaveoptions). Using this class we can assign different conversion parameters while converting EPS to WMF.
<br>
