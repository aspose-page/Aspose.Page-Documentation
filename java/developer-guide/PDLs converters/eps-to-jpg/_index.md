...
description: EPS to JPG conversion functionality offered by Aspose.Page API solution for Java is explained and illustrated with the code snippets here.
---
...
Aspose.Page for Java EPS to JPG converter allows to convert Encapsulated PostScript (EPS) file to JPEG image on any OS for which Java Virtual Machine exists.
...
<br>Following code snippet shows how to convert EPS to JPG files in Java:
<br>
```Java
...
```
{{% alert color="primary" %}}
See EPS to JPG conversion in [.NET](/page/net/convert/eps-to-jpg/) and [C++](/page/cpp/convert/eps-to-jpg/).
{{% /alert %}}

Let's consider [ImageSaveOptions](https://apireference.aspose.com/page/java/com.aspose.eps.device/imagesaveoptions). Using this class we can assign different conversion parameters while converting EPS to JPG.
<br>
