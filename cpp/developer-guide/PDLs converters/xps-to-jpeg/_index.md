...
4. Specify **SmoothingMode**, **Resolution** and other options of [JpegSaveOptions](https://reference.aspose.com/page/cpp/class/aspose.page.x_p_s.presentation.image.jpeg_save_options).
...
Let's consider [JpegSaveOptions](https://reference.aspose.com/page/cpp/class/aspose.page.x_p_s.presentation.image.jpeg_save_options). Using this class we can assign different conversion parameters while converting XPS to JPG.
<br>
