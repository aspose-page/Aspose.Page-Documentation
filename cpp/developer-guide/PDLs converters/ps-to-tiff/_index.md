...
```
{{% alert color="primary" %}}
See PS to TIFF conversion in [.Net](/page/net/convert/ps-to-tiff/) and [Java](/page/java/convert/ps-to-tiff/).
{{% /alert %}}

Let's consider [ImageSaveOptions](https://apireference.aspose.com/page/cpp/class/aspose.page.e_p_s.device.image_save_options). Using this class we can assign different conversion parameters while converting PS to TIFF.
<br>
